(module fred-update frtime
  ...
  ;;dialog
  (define ft-dialog%
    (standard-container-lift dialog%))
  
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;;subarea/area-containter;;;;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  ;;horzontal-pane
  (define ft-horizontal-pane%
    (pane-lift horizontal-pane%))
  
  ;;vertical-pane
  (define ft-vertical-pane%
    (pane-lift vertical-pane%))
  ...
  ;;horizontal-panel
  (define ft-horizontal-panel%
    (panel-lift horizontal-panel%))
  
  ;;vertical-panel
  (define ft-vertical-panel%
    (panel-lift vertical-panel%))
  
  ;;tab-panel
  (define ft-tab-panel%
    (panel-lift tab-panel%))
  
  ;;group-box-panel
  (define ft-group-box-panel%
    (standard-lift group-box-panel%))
